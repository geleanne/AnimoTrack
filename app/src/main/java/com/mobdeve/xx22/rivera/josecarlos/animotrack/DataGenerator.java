...
public class DataGenerator {
    ...
    public static ArrayList<UpcomingEvent> generateUpcomingEventsData() {
        ...
        tempList.add(new UpcomingEvent(event10, "November 18-20", "Velasco Hall, Room 207", "DLSU Psychology Society", "Test your emotional intelligence and problem-solving skills in this thrilling escape room challenge. Decode clues and escape within 45 minutes to win exciting prizes!", false));
    ...
    public static ArrayList<BookmarkEvent> bookmarkedEvents = new ArrayList<>();
